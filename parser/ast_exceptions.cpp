...
parser::Undefined_Function_Declaration_Ast::~Undefined_Function_Declaration_Ast() { free(information); }
...
parser::Undefined_Constructor_Declaration_Ast::Undefined_Constructor_Declaration_Ast(Code_Information* __code_information, Token* __token, int __inicial_position) {
